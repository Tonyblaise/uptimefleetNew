...
SWIFT_CLASS("_TtC16MapboxNavigation10BackButton")
...
SWIFT_CLASS("_TtC16MapboxNavigation29BannerDismissalViewController")
...
SWIFT_CLASS("_TtC16MapboxNavigation14CarPlayManager")
...
SWIFT_CLASS("_TtC16MapboxNavigation24CarPlayMapViewController")
...
@interface CarPlayMapViewController (SWIFT_EXTENSION(MapboxNavigation)) <CPSessionConfigurationDelegate>
...
SWIFT_CLASS("_TtC16MapboxNavigation31CarPlayNavigationViewController")
...
@interface CarPlayNavigationViewController (SWIFT_EXTENSION(MapboxNavigation)) <CPListTemplateDelegate>
...
@interface CarPlayNavigationViewController (SWIFT_EXTENSION(MapboxNavigation)) <CPSessionConfigurationDelegate>
- (void)sessionConfiguration:(CPSessionConfiguration * _Nonnull)sessionConfiguration contentStyleChanged:(CPContentStyle)contentStyle SWIFT_AVAILABILITY(ios,introduced=13.0);
@end
...
SWIFT_CLASS("_TtC16MapboxNavigation23CarPlaySearchController")
...
SWIFT_CLASS("_TtC16MapboxNavigation16DestinationLabel")
...
SWIFT_CLASS("_TtC16MapboxNavigation32DestinationPreviewViewController")
...
SWIFT_CLASS_NAMED("HighlightedButton") SWIFT_DEPRECATED_MSG("This class is no longer used.")
...
/// <code>TopBannerViewController</code> class. To use <code>InstructionsCardViewController</code>, create an instance of it
...
SWIFT_CLASS("_TtC16MapboxNavigation12JunctionView")
...
typedef SWIFT_ENUM_NAMED(NSInteger, LanesStyleKitResizingBehavior, "ResizingBehavior", closed) {
...
SWIFT_CLASS_NAMED("LineView") SWIFT_DEPRECATED_MSG("This class is no longer used.")
...
SWIFT_CLASS_NAMED("ManeuverContainerView") SWIFT_DEPRECATED_MSG("This class is no longer used.")
...
/// <code>SpeechSynthesizing</code> implementation, using <code>MapboxSpeech</code> framework. Uses pre-caching mechanism for upcoming instructions.
SWIFT_CLASS("_TtC16MapboxNavigation23MapboxSpeechSynthesizer")
@interface MapboxSpeechSynthesizer : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface MapboxSpeechSynthesizer (SWIFT_EXTENSION(MapboxNavigation)) <AVAudioPlayerDelegate>
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer * _Nonnull)player successfully:(BOOL)flag;
@end


SWIFT_CLASS_NAMED("MarkerView") SWIFT_DEPRECATED_MSG("This class is no longer used.")
...
SWIFT_CLASS("_TtC16MapboxNavigation16NavigationCamera")
...
/// An object that notifies a map view when the user’s location changes, minimizing the noise that normally accompanies location updates from a <code>CLLocationManager</code> object.
/// If your application displays a <code>MapView</code> before starting turn-by-turn navigation, call <code>LocationManager.overrideLocationProvider(with:)</code> to override default location provider so that the map view always shows the location snapped to the road network. For example, use this class to show the user’s current location as they wander around town.
/// This class depends on <code>NavigationLocationManager</code> to detect the user’s location as it changes.
SWIFT_CLASS("_TtC16MapboxNavigation26NavigationLocationProvider")
@interface NavigationLocationProvider : NSObject <CLLocationManagerDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// convenience functions for adding <code>Route</code> lines to a map.
...
/// <code>NavigationMapView.highlightBuildings(at:in3D:extrudeAll:completion:)</code> and when <code>extrudeAll</code>
/// parameter is set to <code>false</code>.
@property (nonatomic, strong) UIColor * _Nonnull buildingHighlightColor;
/// Color of all other buildings, which will be highlighted after calling
/// <code>NavigationMapView.highlightBuildings(at:in3D:extrudeAll:completion:)</code> and when <code>extrudeAll</code>
/// parameter is set to <code>true</code>.
@property (nonatomic, strong) UIColor * _Nonnull buildingDefaultColor;
/// Allows to control current user location styling based on accuracy authorization permission on iOS 14 and above.
/// Defaults to <code>false</code>.
/// When user disable the <code>Precise Location</code> property in the settings of current application:
/// If <code>false</code>, user location will be drawn based on style, which was set in <code>NavigationMapView.userLocationStyle</code>.
/// If <code>true</code>, <code>UserHaloCourseView</code> will be shown.
@property (nonatomic) BOOL reducedAccuracyActivatedMode;
@property (nonatomic, strong) UIColor * _Nonnull routeDurationAnnotationSelectedColor;
@property (nonatomic, strong) UIColor * _Nonnull routeDurationAnnotationColor;
@property (nonatomic, strong) UIColor * _Nonnull routeDurationAnnotationSelectedTextColor;
@property (nonatomic, strong) UIColor * _Nonnull routeDurationAnnotationTextColor;
...
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull routeDurationAnnotationFontNames;
/// Initializes a newly allocated <code>NavigationMapView</code> object with the specified frame rectangle.
/// \param frame The frame rectangle for the <code>NavigationMapView</code>.
///
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
/// Returns a <code>NavigationMapView</code> object initialized from data in a given unarchiver.
/// \param coder An unarchiver object.
///
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface NavigationMapView (SWIFT_EXTENSION(MapboxNavigation)) <UIGestureRecognizerDelegate>
- (BOOL)gestureRecognizer:(UIGestureRecognizer * _Nonnull)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer * _Nonnull)otherGestureRecognizer SWIFT_WARN_UNUSED_RESULT;
@end

@class CLLocationManager;

@interface NavigationMapView (SWIFT_EXTENSION(MapboxNavigation)) <CLLocationManagerDelegate>
...
@interface NavigationView (SWIFT_EXTENSION(MapboxNavigation))
- (void)traitCollectionDidChange:(UITraitCollection * _Nullable)previousTraitCollection;
@end
...
/// You initialize a navigation view controller based on a predefined <code>RouteResponse</code> and <code>NavigationOptions</code>. As the user progresses along the route, the navigation view controller shows their surroundings and the route line on a map. Banners above and below the map display key information pertaining to the route. A list of steps and a feedback mechanism are accessible via the navigation view controller.
...
/// important:
/// Creating an instance of this type with parameters that uses <code>RouteController</code> with will start an Active
...
/// This class depends on <code>PassiveLocationManager</code> to detect the user’s location as it changes. If you want location updates but do not need to display them on a map and do not want a dependency on the MapboxNavigation module, you can use <code>PassiveLocationManager</code> instead of this class.
SWIFT_CLASS("_TtC16MapboxNavigation23PassiveLocationProvider")
@interface PassiveLocationProvider : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC16MapboxNavigation13PreviewButton")
...
SWIFT_CLASS("_TtC16MapboxNavigation21PreviewViewController")
...
SWIFT_CLASS_NAMED("ProgressBar") SWIFT_DEPRECATED_MSG("This class is no longer used.")
...
SWIFT_CLASS_NAMED("ReportButton") SWIFT_DEPRECATED_MSG("This class is no longer used.")
...
/// in <code>PreviewViewController</code>.
SWIFT_CLASS("_TtC16MapboxNavigation26RoutePreviewViewController")
...
/// A route voice controller monitors turn-by-turn navigation events and triggers playing spoken instructions as audio using the instance of <code>SpeechSynthesizing</code> type.
/// You initialize a voice controller using a <code>NavigationService</code> instance. The voice controller observes when the navigation service hints that the user has passed a <em>spoken instruction point</em> and responds by calling it’s <code>speechSynthesizer</code> to handle the vocalization.
/// If you want to use your own custom <code>SpeechSynthesizing</code> implementation - also pass it during initialization. If no implementation is provided - <code>MultiplexedSpeechSynthesizer</code> will be used by default.
/// You can also subclass <code>RouteVoiceController</code> to implement you own mechanism of monitoring navgiation events and calling <code>speechSynthesizer</code>.
...
@interface RouteVoiceController (SWIFT_EXTENSION(MapboxNavigation)) <AVAudioPlayerDelegate>
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer * _Nonnull)player successfully:(BOOL)flag;
@end
...
SWIFT_CLASS("_TtC16MapboxNavigation11StartButton")
...
SWIFT_CLASS_NAMED("SubtitleLabel") SWIFT_DEPRECATED_MSG("This class is no longer used.")
...
SWIFT_CLASS("_TtC16MapboxNavigation23SystemSpeechSynthesizer")
...
@interface SystemSpeechSynthesizer (SWIFT_EXTENSION(MapboxNavigation)) <AVSpeechSynthesizerDelegate>
...
SWIFT_CLASS_NAMED("TitleLabel") SWIFT_DEPRECATED_MSG("This class is no longer used.")
...
SWIFT_CLASS("_TtC16MapboxNavigation14TopPaddingView")
...
@interface UICollectionViewFlowLayout (SWIFT_EXTENSION(MapboxNavigation))
...
SWIFT_CLASS("_TtC16MapboxNavigation18UserHaloCourseView")
@interface UserHaloCourseView : UIView
/// Sets the inner fill color of the user halo.
@property (nonatomic, strong) UIColor * _Nonnull haloColor;
/// Sets the ring fill color of the circle around the user halo.
@property (nonatomic, strong) UIColor * _Nonnull haloRingColor;
/// Sets the ring size by the radius of the user halo.
@property (nonatomic) double haloRadius;
/// Sets the halo ring border width.
@property (nonatomic) double haloBorderWidth;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)traitCollectionDidChange:(UITraitCollection * _Nullable)previousTraitCollection;
@end
...
@property (nonatomic, strong) UIColor * _Nonnull stalePuckColor SWIFT_DEPRECATED_MSG("No stale status in active navigation anymore.");
